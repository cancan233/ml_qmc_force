...
train_images = tr("../../00_data/dmc_optJ_eq_only/dmc_400blocks_set3.traj")

atoms = tr("../dft/md_nvt_dft.traj")[0]
...
trainer.load_pretrained(
    "../../01_train/amptorch_dmc/checkpoints/2022-05-09-19-01-57-test"
)
