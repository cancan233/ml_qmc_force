...
images = tr(
    "../../../data/dmc/dmc_400blocks_set3.traj"
)
...
trainer.load_pretrained(
   "../checkpoints/2022-05-09-19-01-57-test"
)
...
# test_images = tr("../../../data/dmc/dmc_400blocks_set0.traj")
...
validate_images = tr("../../../data/dmc/dmc_theta.traj")
...
validate_images = tr("../../../data/dmc/dmc_r1.traj")
predictions = trainer.predict(validate_images)
...
validate_images = tr("../../../data/dmc/dmc_r2.traj")
predictions = trainer.predict(validate_images)
