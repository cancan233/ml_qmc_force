...
images = tr(
    "/Users/cancan/Dropbox (Brown)/000_Research/ML_DMC/examples/ch3cl/data/train_dmc.traj"
)
...
amp_dmc_traj = tw("ch3cl_amptorch_dmc_train.traj")
...
test_images = tr("/Users/cancan/Dropbox (Brown)/000_Research/ML_DMC/examples/ch3cl/data/test_dmc.traj")
...
amp_dmc_traj = tw("ch3cl_amptorch_dmc_test.traj")
